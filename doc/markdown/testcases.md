...
* **SCENARIO_TEMPLATE_TUPLE(** _scenario name_, _type_, _tuple of types_ **)**

This macro maps onto ```TEST_CASE_TEMPLATE_TUPLE``` and works in the same way, except that the test case name will be prefixed by "Scenario: "
